...
var getCache = function getCache(emitter) {
    ...
    var cache = []; // cache does not exist, so we need to bind its listener
...
function isEventEmitter2(obj) {
    return !!(obj && obj.on !== undefined && obj.onAny !== undefined && obj.once !== undefined);
}

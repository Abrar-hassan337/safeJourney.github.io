(function(w, d) {
        ...
        util: {
            ...
            getBaseDomain: function() {
                ...
                if (domain) {
                    try {
                        ...
                        io.util.logErrors("Shared Utils", "getBaseDomain() error", "domain:" + domain + " msg:" + e.message)
                    }
                }
                return domain
            },
            ...
            logErrors: function(loc, evt, msg, version, accountId) {
                try {
                    ...
                    io.util.log(loc + " (in utils)", evt, msg + " | " + e.message)
                }
            },
    ...
    function logErrors(evt, msg) {
        u.logErrors("UTT", evt, msg, version, accountId)
    }
    ...
    Event.prototype = {
        ...
        identify: function(props, options) {
            ...
            try {
                ...
                if (willFireIdentify) {
                    doTracking(nodeSrc, camp, options, "identify", getSlugs(isChannel), null, null, gatewayClickId)
                } else {
                    doReporter(options.id || getId(), {
                        type: "Identify",
                        options: options,
                    ...
                    this.identifyUser(props, options, camp)
                }
                ...
                if (camp.ld) {
                    this.autoCrossDomainLinks(props, options, camp)
                }
        ...
        trackConversion: function(trackId, props, options) {
            ...
            try {
                ...
                if (!camp) {
                    logErrors("trackConversion() exit", "campaign not found for tracker:" + trackId);
                    return this
                }
                doSessionSpecificTasks(this, camp);
        ...
        track: function(evt, props, options) {
            ...
            try {
                if (props.actionTrackerId) {
                    ...
                    if (!camp) {
                        logErrors("track() exit", "campaign not found for event:" + evt);
                        return this
                    }
        ...
        trackCart: function(trackerId, props, options) {
            ...
            try {
                ...
                var src;
                if (!camp) {
                    logErrors("trackCart() exit", "campaign not found for tracker:" + trackerId);
                    return this
                }
        ...
        generateClickId: function(callback, props, options) {
            ...
            if (getGatewayClickId()) {
                return callback ? callback(getGatewayClickId()) : getGatewayClickId()
            }
            ...
            function setUuidAndDoCallback(uuid) {
        ...
        identifyUser: function(props, options, passedCampaign) {
            props = props || {};
            ...
            if (!camp) {
                logErrors("identifyUser() exit", "No campaign for landing page: " + landingPage);
                return this
            }
            ...
            doTracking(src, camp, options, "identifyUser", getSlugObject("cur", "xur", "ur", "iur"), null, null, getGatewayClickId())
        },
        crossDomainLink: function(url, callback, props, options, passedCampaign) {
            props = props || {};
            options = options || {};
            var me = this;
            ...
            function getLink() {
                ...
                if (!u.strContains(url, "_ics=" + getCurrentSessionId())) {
                    ...
                    url += buildQueryParam(props.clickParam || camp.gc || "clickid", me.generateClickId())
                }
                return url
            }
        ...
        autoCrossDomainLinks: function(props, options, passedCampaign) {
            ...
            function doLinks(links) {
                for (var x = 0, xx = links.length; x < xx; x++) {
                    ...
                    href = a.href;
                    if (!u.isEmpty(href)) {
                        hrefDomain = String(u.extractDomain(href)).toLowerCase();
                        if (!u.strContains(hrefDomain, domain)) {
                            if ((props.domains && u.arrayContains(props.domains, hrefDomain, true)) || regexMatch(camp.d, stripProtocol(href), true)) {
                                a.href = me.crossDomainLink(href, null, props, options, camp)
                            }
                        }
                    }
                }
    ...
    var irEvent = new ImpactRadiusEvent("A399180-581c-436c-a921-89d05ddbb71f1", "U359", [{
        id: "5610",
        td: "flixbus.sjv.io",
        ad: "385844",
        iw: null,
        ti: ["12573", "12868"],
        d: "(?:(?:.*?\\.shop\\.flixbus\\.al)|(?:^shop\\.flixbus\\.al)|(?:.*?\\.shop\\.flixbus\\.at)|(?:^shop\\.flixbus\\.at)|(?:.*?\\.shop\\.flixbus\\.ba)|(?:^shop\\.flixbus\\.ba)|(?:.*?\\.shop\\.flixbus\\.be)|(?:^shop\\.flixbus\\.be)|(?:.*?\\.shop\\.flixbus\\.bg)|(?:^shop\\.flixbus\\.bg)|(?:.*?\\.shop\\.flixbus\\.cat)|(?:^shop\\.flixbus\\.cat)|(?:.*?\\.shop\\.flixbus\\.ch)|(?:^shop\\.flixbus\\.ch)|(?:.*?\\.shop\\.flixbus\\.co\\.uk)|(?:^shop\\.flixbus\\.co\\.uk)|(?:.*?\\.shop\\.flixbus\\.com\\.ua)|(?:^shop\\.flixbus\\.com\\.ua)|(?:.*?\\.shop\\.flixbus\\.com)|(?:^shop\\.flixbus\\.com)|(?:.*?\\.shop\\.flixbus\\.cz)|(?:^shop\\.flixbus\\.cz)|(?:.*?\\.shop\\.flixbus\\.de)|(?:^shop\\.flixbus\\.de)|(?:.*?\\.shop\\.flixbus\\.dk)|(?:^shop\\.flixbus\\.dk)|(?:.*?\\.shop\\.flixbus\\.es)|(?:^shop\\.flixbus\\.es)|(?:.*?\\.shop\\.flixbus\\.fr)|(?:^shop\\.flixbus\\.fr)|(?:.*?\\.shop\\.flixbus\\.hr)|(?:^shop\\.flixbus\\.hr)|(?:.*?\\.shop\\.flixbus\\.hu)|(?:^shop\\.flixbus\\.hu)|(?:.*?\\.shop\\.flixbus\\.it)|(?:^shop\\.flixbus\\.it)|(?:.*?\\.shop\\.flixbus\\.mk)|(?:^shop\\.flixbus\\.mk)|(?:.*?\\.shop\\.flixbus\\.nl)|(?:^shop\\.flixbus\\.nl)|(?:.*?\\.shop\\.flixbus\\.no)|(?:^shop\\.flixbus\\.no)|(?:.*?\\.shop\\.flixbus\\.pl)|(?:^shop\\.flixbus\\.pl)|(?:.*?\\.shop\\.flixbus\\.pt)|(?:^shop\\.flixbus\\.pt)|(?:.*?\\.shop\\.flixbus\\.ro)|(?:^shop\\.flixbus\\.ro)|(?:.*?\\.shop\\.flixbus\\.rs)|(?:^shop\\.flixbus\\.rs)|(?:.*?\\.shop\\.flixbus\\.ru)|(?:^shop\\.flixbus\\.ru)|(?:.*?\\.shop\\.flixbus\\.se)|(?:^shop\\.flixbus\\.se)|(?:.*?\\.shop\\.flixbus\\.si)|(?:^shop\\.flixbus\\.si)|(?:.*?\\.shop\\.flixbus\\.sk)|(?:^shop\\.flixbus\\.sk)|(?:.*?\\.shop\\.global\\.flixbus\\.com)|(?:^shop\\.global\\.flixbus\\.com)|(?:.*?\\.shop\\.global\\.flixbus\\.com)|(?:^shop\\.global\\.flixbus\\.com))",
        pc: [{
            "411620": {
                r: [
                    [{
        ...
        id: "5611",
        td: "flixbus-charter.sjv.io",
        ad: "385847",
        iw: null,
        ti: ["12574"],
        d: "(?:(?:.*?\\.charter\\.flixbus\\.com)|(?:^charter\\.flixbus\\.com)|(?:.*?\\.mieten\\.flixbus\\.de)|(?:^mieten\\.flixbus\\.de)|(?:.*?\\.location\\.flixbus\\.fr)|(?:^location\\.flixbus\\.fr)|(?:.*?\\.noleggio\\.flixbus\\.it)|(?:^noleggio\\.flixbus\\.it)|(?:.*?\\.wynajem\\.flixbus\\.pl)|(?:^wynajem\\.flixbus\\.pl)|(?:.*?\\.huren\\.flixbus\\.nl)|(?:^huren\\.flixbus\\.nl)|(?:.*?\\.baoche\\.flixbus\\.com)|(?:^baoche\\.flixbus\\.com))",
        pc: [{
            "411620": {
                r: [
                    [{
        ...
        iw: null,
        ti: ["12576", "20826"],
        d: "(?:(?:.*?\\.flixdeal\\.flixbus\\.com)|(?:^flixdeal\\.flixbus\\.com))",
        pc: [{
            "411620": {
                r: [
                    [{
        ...
        id: "11026",
        td: "flixcar.8bjsq8.net",
        ad: "760069",
        iw: null,
        ti: ["20005"],
        d: "(?:(?:.*?\\.www\\.flixcar\\.fr)|(?:^www\\.flixcar\\.fr))",
        gp: "irgwc",
        gc: "irclickid",
        csc: {
            domReady: 1,

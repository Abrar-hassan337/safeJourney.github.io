! function(e, t) {
    ...
    return function(e) {
        ...
        function c(e) {
            ...
            if (n && i.length < 6)
                for (var y = void 0, k = i.length; k < 6; k += 1) {
                    y = i[i.length - 1];
                ...
                return u(t, e), c(t, [{
                    ...
                    value: function(e) {
                        var t = this,
                            ...
                            o = w.nodeListToArray(n).indexOf(e); - 1 !== o && (0 === o ? this.showPreviousMonth(function() {
                    ...
                    value: function(e) {
                        var t = this,
                            n = w.getDayNodes(this.dayPicker, this.props.classNames),
                            o = w.nodeListToArray(n).indexOf(e); - 1 !== o && (o === n.length - 1 ? this.showNextMonth(function() {
